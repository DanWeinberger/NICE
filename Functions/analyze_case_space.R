analyze_case_space_func <- function(DownLoadLatest=F) {
  ...
  d1$period <-NA
  d1$period[d1$Date_of_publication<as.Date('2020-09-01') ] <- 0
  
  d1$period[d1$Date_of_publication>=as.Date('2020-09-01') &d1$Date_of_publication<=as.Date('2020-11-30')  ] <- 1
  d1$period[d1$Date_of_publication>=as.Date('2020-12-01')  ] <- 2
