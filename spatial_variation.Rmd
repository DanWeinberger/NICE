...
plot(case.dates[case.period], case.wk$Lansingerland[case.period], type='l', main='Cases Lansingerland', ylab='N_cases')
...
plot(nice.dates[nice.period], nice.wk$Lansingerland[nice.period], type='l', main='Hos. Admissions Lansingerland', ylab="N_hosp")
