...
```{r}
extrap.case <- extrap.func(week.rr=0.75, ds=case.data, n.extrap=45)

```

```{r}
plot(extrap.case$date, extrap.case$Total_reported, type='l', col='gray', ylab='Expected cases', bty='l', main='Assume 25% decline/week for 45 days')
...
```{r}
extrap.nice <- extrap.func(week.rr=0.75, ds=nice.data, n.extrap=45)
```

```{r}
plot(extrap.nice$date, extrap.nice$Hospital_admission, type='l', col='gray', ylab='Expected cases', bty='l', main='Assume 25% decline/week for 45 days')
